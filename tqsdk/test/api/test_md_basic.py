...
class TestMdBasic(unittest.TestCase):
    ...
    def test_get_quote_normal(self):
        ...
        self.mock.run(os.path.join(dir_path, "log_file", "test_md_basic_get_quote_normal.lzma"))
        # 获取行情
    ...
    def test_get_kline_serial(self):
        ...
        # 预设服务器端响应
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.mock.run(os.path.join(dir_path, "log_file", "test_md_basic_get_kline_serial.lzma"))
    ...
    def test_get_tick_serial(self):
        ...
        # 预设服务器端响应
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.mock.run(os.path.join(dir_path, "log_file", "test_md_basic_get_tick_serial.lzma"))
