...
class TestTdBacktest(unittest.TestCase):
    ...
    def test_various_combinations_of_order_1(self):
        ...
        self.mock.run(os.path.join(dir_path, "log_file", "test_various_combinations_of_order_1.lzma"))
        # 测试1：单次开平 * n次
    ...
    def test_various_combinations_of_order_2(self):
        ...
        # 预设服务器端响应
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.mock.run(os.path.join(dir_path, "log_file", "test_various_combinations_of_order_2.lzma"))
        # 测试2：多次开,一次全平完
        TqApi.RD = random.Random(4)
        api = TqApi(backtest=TqBacktest(start_dt=datetime(2019, 12, 10, 9), end_dt=datetime(2019, 12, 11)),
                    _ins_url=self.ins_url, _td_url=self.td_url, _md_url=self.md_url)
    ...
    def test_various_combinations_of_order_3(self):
        ...
        # 预设服务器端响应
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.mock.run(os.path.join(dir_path, "log_file", "test_various_combinations_of_order_3.lzma"))
        # 测试3：多次开 分多次平完
        TqApi.RD = random.Random(4)
        api = TqApi(backtest=TqBacktest(start_dt=datetime(2019, 12, 10, 9), end_dt=datetime(2019, 12, 11)),
                    _ins_url=self.ins_url, _td_url=self.td_url, _md_url=self.md_url)
    ...
    def test_various_combinations_of_order_4(self):
        ...
        # 预设服务器端响应
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.mock.run(os.path.join(dir_path, "log_file", "test_various_combinations_of_order_4.lzma"))
        # 测试4：单次开 分多次平完
        TqApi.RD = random.Random(4)
        api = TqApi(backtest=TqBacktest(start_dt=datetime(2019, 12, 10, 9), end_dt=datetime(2019, 12, 11)),
                    _ins_url=self.ins_url, _td_url=self.td_url, _md_url=self.md_url)
